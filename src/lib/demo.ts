...
<svg xmlns="http://www.w3.org/2000/svg" width="1240" height="1754" viewBox="0 0 1240 1754">
  ...
  <text x="78" y="198" font-family="Arial, sans-serif" font-size="18" fill="#637169">${tr('EXPENSE REPORT — MAY 2026', 'NOTE DE FRAIS — MAI 2026')}</text>
  <rect x="78" y="250" width="1084" height="1" fill="#dce1dc"/>
  <text x="78" y="320" font-family="Arial, sans-serif" font-size="16" fill="#728078">${tr('EMPLOYEE', 'COLLABORATRICE')}</text>
  ...
  <text x="355" y="552" font-family="Arial, sans-serif" font-size="18" font-weight="700" fill="#4b5b53">${tr('ITEM', 'OBJET')}</text>
  <text x="930" y="552" font-family="Arial, sans-serif" font-size="18" font-weight="700" fill="#4b5b53">${tr('AMOUNT', 'MONTANT')}</text>
  ...
  <g font-family="Arial, sans-serif" font-size="20" fill="#26332d">
    ...
    <text x="104" y="708">06/05/2026</text><text x="355" y="708">${tr('Client lunch', 'Déjeuner client')}</text><text x="930" y="708">74,50 €</text>
    <text x="104" y="778">07/05/2026</text><text x="355" y="778">${tr('Hotel', 'Hôtel')}</text><text x="930" y="778">189,00 €</text>
  </g>
  <g stroke="#e3e7e3">
  ...
  <text x="108" y="956" font-family="Arial, sans-serif" font-size="17" font-weight="700" fill="#66756d">${tr('REIMBURSEMENT', 'REMBOURSEMENT')}</text>
  <text x="108" y="1010" font-family="Arial, sans-serif" font-size="20" fill="#26332d">${tr('Account holder', 'Titulaire')} : Léa Martin</text>
  <text x="108" y="1056" font-family="Arial, sans-serif" font-size="20" fill="#26332d">IBAN : FR76 3000 6000 0112 3456 7890 189</text>
  <text x="108" y="1102" font-family="Arial, sans-serif" font-size="20" fill="#26332d">${tr('Date of birth', 'Date de naissance')} : 14/02/1991</text>

  <rect x="78" y="1260" width="1084" height="1" fill="#dce1dc"/>
  <text x="78" y="1328" font-family="Arial, sans-serif" font-size="16" fill="#728078">${tr('COMMENT', 'COMMENTAIRE')}</text>
  <text x="78" y="1372" font-family="Arial, sans-serif" font-size="20" fill="#26332d">${tr('Please send a copy to the external accounting department.', 'Merci de transmettre une copie au service comptable externe.')}</text>
  <text x="78" y="1608" font-family="Arial, sans-serif" font-size="16" fill="#98a39d">${tr('Synthetic document — no real data', 'Document synthétique — aucune donnée réelle')}</text>
</svg>`
...
export function createDemo(): { document: SafeDocument; findings: Finding[] } {
  const document: SafeDocument = {
    id: `demo-${Date.now()}`,
    name: tr('sample-expense-report.pdf', 'note-de-frais-demo.pdf'),
    kind: 'demo',
    size: 184_000,
    createdAt: Date.now(),
    pages: [
